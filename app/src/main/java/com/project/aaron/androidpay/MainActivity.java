package com.project.aaron.androidpay;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private String TAG = "WalletExample_";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mWalletFragment == null){
            ...
            WalletFragmentInitParams.Builder startParamsBuilder = WalletFragmentInitParams.newBuilder()
                    ...
                    .setAccountName("Test Wallet App");
    ...
    public MaskedWalletRequest generateMaskedWalletRequest(){
        ...
        PaymentMethodTokenizationParameters parameters = getTokenParameters(publicKey);
        MaskedWalletRequest maskedWalletRequest = getMaskedWalletRequest(parameters);

        return maskedWalletRequest;
    }

    public PaymentMethodTokenizationParameters getTokenParameters(String pk){
        return PaymentMethodTokenizationParameters.newBuilder()
                .setPaymentMethodTokenizationType(PaymentMethodTokenizationType.NETWORK_TOKEN)
                .addParameter("publicKey", pk)
                .build();
    }

    public MaskedWalletRequest getMaskedWalletRequest(PaymentMethodTokenizationParameters params){
        return MaskedWalletRequest.newBuilder()
                .setMerchantName("Test Example with Android Wallet")
                ...
                .setCart( Cart.newBuilder()
                            ...
                            .addLineItem(LineItem.newBuilder()
                                            .setCurrencyCode("USD")
                                            .setDescription("Test Example with Android Wallet")
                                            .setQuantity("1")
                                            .setUnitPrice("10.00")
                                            .setTotalPrice("10.00")
                                            .build())
            ...
            case FULL_WALLET_REQUEST_CODE:
                switch (resultCode) {
                    case RESULT_OK:
                        ...
                        Log.d(TAG, "onActivityResult: " + mFullWallet.getPaymentMethodToken().getToken());
                        break;
                    case WalletConstants.RESULT_ERROR:
                        Toast.makeText(this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                        break;
